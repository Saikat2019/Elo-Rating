...
class EloTSPlot2(Scene):
    def construct(self):
        ...
        series1 = np.random.normal(0, 200, n) + 1500 + 1400 * t/10
        # Generate second random walk series starting at 1500
        series2 = np.random.normal(0, 50, n) + 1000 + 800 * t/10
        ...
        lab2 = Text("Small K", font_size=35, color=GREEN, font="sans-serif").next_to(line2, RIGHT*18+UP)
        self.add(line2, lab2)
        ...
        lab1 = Text("Large K", font_size=35, color=RED, font="sans-serif").next_to(line1, UP*12+RIGHT*2)
        self.add(line1, lab1)
        for i in range(1, len(t)):
            # Update first line by adding new point
